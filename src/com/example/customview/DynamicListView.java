...
public class DynamicListView extends ListView {
    ...
    public ArrayList<PanelContentsListItem> mPanelList;
...
//                Log.e("check", "mPanelList.size() = " + (mPanelList.size() - 1) + "   pointToPosition = " +  pointToPosition((int)event.getX(), (int)event.getY()));
    ...
    public void setPanelList(ArrayList<PanelContentsListItem> panelList) {
        mPanelList = panelList;
    }
    ...
    public void addPanel(){
    	mPanelList.add(new PanelContentsListItem(null));
		((RightDrawerListAdapter) getAdapter()).setTagID();
		((RightDrawerListAdapter) getAdapter()).setTagSelect();
		swapElements(mPanelList, mPanelList.size() - 1, mPanelList.size() - 2);
		((BaseAdapter) getAdapter()).notifyDataSetChanged();
